...
namespace Hashed_Database_Users
{
    public class User
    {
        ...
        private void addSaltAndPepper()
        {
            ...
            seasoning.Add("4b4f7a71");
            seasoning.Add("966926f7");
            seasoning.Add("b497de1c");
            seasoning.Add("8c56c111");
            seasoning.Add("f3375xb2");

            Random s = new Random();
            int salt = s.Next(0, 10);

            Random p = new Random();
            int pepper = p.Next(0, 10);
        ...
        public bool verifyHash(string hash)
        {
            ...
            string cut = this.hashed_password.Substring(8, this.hashed_password.Length - 16);
